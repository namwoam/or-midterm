...
def random_car_level(benchmark: BaseBenchmark, car_count: int):
    level_count = len(benchmark.rates)
    for car_id in car_count:
        benchmark.cars.append(Car(car_id+1, randint(1, level_count)))


def middle_normal_car_level(benchmark: BaseBenchmark, car_count: int):
    level_count = len(benchmark.rates)
...
def decreasing_normal_car_level(benchmark: BaseBenchmark, car_count: int):
    level_count = len(benchmark.rates)
